      ...
      <main className="flex-grow">
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container relative mx-auto px-4 text-center">
            <h1 className="font-headline text-4xl font-extrabold tracking-tight bg-gradient-to-b from-amber-300 via-yellow-400 to-amber-500 bg-clip-text text-transparent drop-shadow-md sm:text-5xl md:text-6xl">
